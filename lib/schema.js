...
const { venue, location, menu, menuItem, item, category, modifierGroup, modifierOption, printGroup, taxGroup, reportingGroup } = types;
const RootQuery = `
  type RootQuery {
    venue(id: Int!): Venue
...
module.exports = makeExecutableSchema({
  typeDefs: [
    SchemaDefinition,
    RootQuery,
    venue, location, menu, menuItem, item, category, modifierGroup, modifierOption, printGroup, taxGroup, reportingGroup,
    mutations
  ],
  resolvers: resolvers
});
